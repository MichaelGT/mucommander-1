...
public class MuPreferences implements MuPreferencesAPI {
     ...
     */
    public static final String EXTERNAL_TERMINAL_TYPE = TERMINAL_SECTION + '.' + "external_terminal_type";
    /**
     * Default external terminal type.
     */
    public static final TerminalType DEFAULT_EXTERNAL_TERMINAL_TYPE = TerminalType.DEFAULT;
    ...
    public enum TerminalType {
        ...
        public static TerminalType valueOf(int type) {

...
public enum MuPreference {
    ...
    STORE_WINDOWS_SIZES_AND_LOCATIONS(MuPreferences.STORE_WINDOWS_SIZES_AND_LOCATIONS),
    ...
    SYNTAX_THEME_NAME(MuPreferences.SYNTAX_THEME_NAME),
    ...
    CALCULATE_FOLDER_SIZE_ON_MARK(MuPreferences.CALCULATE_FOLDER_SIZE_ON_MARK),
    MARK_FOLDERS_WITH_FILES(MuPreferences.MARK_FOLDERS_WITH_FILES),
    MARK_FILES_CASE_SENSITIVE_FILTER(MuPreferences.MARK_FILES_CASE_SENSITIVE_FILTER),
    BLOCK_MARK_STEP_SIZE(MuPreferences.BLOCK_MARK_STEP_SIZE),
    FILE_GROUP_1_MASK(MuPreferences.FILE_GROUP_1_MASK),
    FILE_GROUP_2_MASK(MuPreferences.FILE_GROUP_2_MASK),
    FILE_GROUP_3_MASK(MuPreferences.FILE_GROUP_3_MASK),
    FILE_GROUP_4_MASK(MuPreferences.FILE_GROUP_4_MASK),
    FILE_GROUP_5_MASK(MuPreferences.FILE_GROUP_5_MASK),
    FILE_GROUP_6_MASK(MuPreferences.FILE_GROUP_6_MASK),
    ...
    EXTERNAL_TERMINAL_TYPE(MuPreferences.EXTERNAL_TERMINAL_TYPE),
    TERMINAL_SHELL(MuPreferences.TERMINAL_SHELL),
    TERMINAL_USE_CUSTOM_SHELL(MuPreferences.TERMINAL_USE_CUSTOM_SHELL),
    FIND_FILE_ENCODING(MuPreferences.FIND_FILE_ENCODING),
    FIND_FILE_SUBDIRECTORIES(MuPreferences.FIND_FILE_SUBDIRECTORIES),
    FIND_FILE_ARCHIVES(MuPreferences.FIND_FILE_ARCHIVES),
    FIND_FILE_IGNORE_HIDDEN(MuPreferences.FIND_FILE_IGNORE_HIDDEN),
    FIND_FILE_CASE_SENSITIVE(MuPreferences.FIND_FILE_CASE_SENSITIVE),
    FIND_FILE_SEARCH_HEX(MuPreferences.FIND_FILE_SEARCH_HEX);

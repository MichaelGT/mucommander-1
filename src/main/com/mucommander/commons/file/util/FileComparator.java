...
public class FileComparator implements Comparator<AbstractFile> {
     ...
     */
    public FileComparator(int criterion, SortOrder sortOrder, boolean directoriesFirst, boolean foldersAlwaysAlphabetical, QuickSearch quickSearch) {
    ...
    public FileComparator(int criterion, SortOrder sortOrder, boolean directoriesFirst, boolean foldersAlwaysAlphabetical) {
        this(criterion, sortOrder, directoriesFirst, foldersAlwaysAlphabetical, null);
    }
    ...
    public int compare(AbstractFile f1, AbstractFile f2) {
        ...
        return sortOrder.isAsc() ? intValue : -intValue; // Note: ascending is used more often, more efficient to negate for descending
    }
    ...
    public boolean equals(Object o) {
        ...
        return criterion == fc.criterion && sortOrder == fc.sortOrder;
    }
